...
-- *******************************************************************
--  Here is the start of the HW2. Everything here is done by bdwark01
-- *******************************************************************
...
SELECT vendor_name, vendor_address1, vendor_address2
FROM vendors
WHERE vendor_state IN ('OH', 'NJ');

SELECT COUNT(*)
FROM vendors
WHERE vendor_state IN ('OH', 'NJ');

SELECT vendor_state, COUNT(*) AS vendor_count
FROM vendors
...
SELECT vendor_id, COUNT(*) AS invoice_count
FROM invoices
WHERE YEAR(invoice_date) = 2018 AND MONTH(invoice_date) <= 6
GROUP BY vendor_id;