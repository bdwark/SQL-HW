...
CREATE TABLE artist_bdwark01
(
	artist_name 		VARCHAR(255) 	NOT NULL,
    artist_dateOfBirth 	DATE 			NOT NULL,
    artist_address 		VARCHAR(128) 	NOT NULL,
	artist_genre 		ENUM('rock', 'pop', 'country', 'jazz', 'folk', 'other') 	NOT NULL,
    CONSTRAINT artist_pk 
		PRIMARY KEY (artist_name)
);


INSERT INTO artist_bdwark01 VALUES 
('Korah Blanca','1998-05-08','1555 W Lane Ave, Columbus, OH, 43221','country'), 
('Yash Randall','1989-07-18','11 E Rancho Madera Rd, Madison, WI, 53707','folk'), 
('Johnathon Millerton','1999-02-12','60 Madison Ave, New York, NY, 10010','other'), 
('Mikayla Damion','2004-07-11','2021 K Street Nw, Washington, DC, 20006','jazz'), 
('Kendall Mayte','1997-11-16','4775 E Miami River Rd, Cleves, OH, 45002','other'), 
('Kaitlin Hostlery','1997-02-21','3250 Spring Grove Ave, Cincinnati, OH, 45225','other'), 
('Derek Chaddick','2000-01-25','9022 E Merchant Wy, Fairfield, IA, 52556','pop'), 
('Deborah Damien','1976-12-29','415 E Olive Ave, Fresno, CA, 93728','folk'), 
('Karina Lacy','1994-03-30','882 W Easton Wy, Los Angeles, CA, 90084','rock'), 
('Kurt Nickalus','1989-09-25','28210 N Avenue Stanford, Valenci, CA, 91355','pop'), 
('Kelsey Eulalia','1979-10-02','7833 N Ridge Rd, Sacramento, CA, 95887','country'), 
('Anders Rohansen','1969-06-09','12345 E 67th Ave NW, Takoma Park, MD, 24512','country'), 
('Thalia Neftaly','1994-02-14','2508 W Shaw Ave, Fresno, CA, 93711','country'), 
('Gonzalo Keeton','1986-11-15','12 Daniel Road, Fairfield, NJ, 07004','pop'), 
('Ania Irvin','1990-11-11','1099 N Farcourt St, Orange, CA, 92807','other'), 
('Dakota Baylee','1954-11-28','1033 N Sycamore Ave, Los Angeles, CA, 90038','folk'), 
('Samuel Jacobsen','1986-12-23','3433 E Widget Ave, Palo Alto, CA, 92711','jazz'), 
('Justin Javen','1998-08-14','828 S Broadway, Tarrytown, NY, 10591','pop'), 
('Kyle Marissa','1997-09-18','789 E Mercy Ave, Phoenix, AZ, 85038','pop'), 
('Erick Kaleigh','1979-11-17','Five Lakepointe Plaza, Ste 500, Charlotte, NC, 28217','other'), 
('Marvin Quintin','1975-11-05','2677 Industrial Circle Dr, Columbus, OH, 43260','folk'), 
('Rashad Holbrooke','1987-06-02','3467 W Shaw Ave #103, Fresno, CA, 93711','folk'), 
('Trisha Anum','1986-02-02','627 Aviation Way, Manhatttan Beach, CA, 90266','country'), 
('Julian Carson','1984-06-07','372 San Quentin, San Francisco, CA, 94161','rock'), 
('Kirsten Story','1982-05-08','2401 Wisconsin Ave NW, Washington, DC, 20559','Other');

SET FOREIGN_KEY_CHECKS=0;
ALTER TABLE items ADD CONSTRAINT fk_artist FOREIGN KEY items(artist) REFERENCES artist_bdwark01(artist_name);
SET FOREIGN_KEY_CHECKS=1;

-- Insert into 'orders'
INSERT INTO orders VALUES (50, 3, '2023-09-13', '2023-09-13');
...
-- Delete from 'orders'
-- DELETE FROM orders WHERE order_id = 29; 
-- you can not delete from a table which is the child in a relationship

-- Delete from 'order_details'
DELETE FROM order_details WHERE order_id = 29;
